...
export const PRESET_SVG_MAP: Record<string, string> = {
  'people-alex': createSvgDataUri(`
  ...
  `),
  'simple-rocket': createSvgDataUri(`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
      <defs>
  ...
  `),
  'simple-diamond': createSvgDataUri(`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
      <defs>
...
export const ALLOWED_PRESET_IDS = Object.keys(PRESET_SVG_MAP);
