...
import { createBlockerSchema, sendMessageSchema } from './blockers.dto';
...
router.put('/blockers/:blockerId', authenticate, asyncHandler(blockersController.updateBlocker));
