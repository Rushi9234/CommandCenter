import { z } from 'zod';
import { requiredString, optionalUuid, optionalString } from '../../common/dto-helpers';
...
export const createGoalSchema = z.object({
  ...
  parentGoalId: optionalUuid('Invalid UUID'),
  targetDate: optionalString(),
  teamId: optionalUuid('Invalid UUID'),
});
...
export const updateGoalSchema = z
  .object({
    ...
    parent_goal_id: z.preprocess((val) => (val === '' ? null : val), z.string().uuid().nullable().optional()),
