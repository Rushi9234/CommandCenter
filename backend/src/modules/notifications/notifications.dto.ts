...
export const NOTIFICATION_PREFERENCE_KEYS = [
  ...
  'phone_verification',
  // Chat V1 Task 4: covers every 'chat.message_created' notification,
  // whether from a direct or a team conversation -- one coarse group,
  // like every other preference here, not a per-conversation toggle.
  'chat_message',
  'guidance',
  'goal_review',
] as const;
