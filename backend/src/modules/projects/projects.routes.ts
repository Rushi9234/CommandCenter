...
import { createProjectSchema, analyzeProjectSchema, createTaskSchema } from './projects.dto';
...
router.put('/projects/:projectId', authenticate, asyncHandler(projectsController.updateProject));
...
router.put('/tasks/:taskId', authenticate, asyncHandler(projectsController.updateTask));
